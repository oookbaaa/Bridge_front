...
export default function EventsPage() {
  const upcomingEvents = [
    ...
    },
    {
      ...
      category: 'Education',
      description:
        'Learn the basics of bridge in this comprehensive workshop designed for newcomers to the game.',
      registrationOpen: true,
      featured: false,
    },
    {
    ...
    },
    {
      ...
      description:
        'Annual international event featuring players from across North Africa and Europe.',
    ...
    },
    {
      ...
      category: 'Youth',
      description:
        'Five-day intensive camp for young players aged 12-18 to develop their bridge skills.',
      registrationOpen: false,
      featured: false,
    },
    {
      ...
      description:
        'Exclusive tournament for master-level players by invitation only.',
      registrationOpen: false,
      featured: false,
    },
  ];
      ...
      <div className="max-w-[1600px] mx-auto px-6 sm:px-8 lg:px-12 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="font-body text-xl text-slate-600 max-w-2xl mx-auto">
            Rejoignez l'action - Ne ratez pas l'excitation! Vérifiez notre
            calendrier et participez à des tournois à travers la Tunisie.
          </p>
        </div>
            ...
            {regularEvents.map((event) => (
              ...
              >
                ...
                <CardContent className="space-y-3">
                  <p className="font-body text-slate-600 text-sm line-clamp-2">
                    {event.description}
                  </p>
        ...
        <div className="mt-16 text-center bg-slate-50 rounded-lg p-8">
          ...
          <p className="font-body text-slate-600 mb-6 max-w-2xl mx-auto">
            Abonnez-vous à notre calendrier d'événements et ne ratez jamais un
            tournoi ou un atelier. Recevez des notifications sur les ouvertures
            d'inscription et les mises à jour des événements.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button variant="outline" size="lg">
              Télécharger le guide des événements
            </Button>
          </div>
        </div>
      </div>
